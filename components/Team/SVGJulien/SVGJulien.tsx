...
const SVGJulien: React.FC<SVGJulienProps> = () => {
  return (
    <svg
      viewBox="0 0 264 280"
      version="1.1"
            ...
            >
              ...
              >
                ...
                <mask id="react-mask-100" fill="white">
                  <use xlinkHref="#react-path-99"></use>
                </mask>
                <use
                  id="Clothes"
                  fill="#E6E6E6"
                  fillRule="evenodd"
                  xlinkHref="#react-path-99"
                ></use>
                <g
              ...
              <g id="Top" strokeWidth="1" fillRule="evenodd">
                ...
                <mask id="react-mask-67" fill="white">
                  <use xlinkHref="#react-path-69"></use>
                </mask>
                <g id="Mask"></g>
                <g id="Top/Short-Hair/Short-Flat" mask="url(#react-mask-67)">
                  <g transform="translate(-1.000000, 0.000000)">
                    ...
                    >
                      ...
                      <mask id="react-mask-121" fill="white">
                        <use xlinkHref="#react-path-122"></use>
                      </mask>
                      <use
                        id="Lite-Beard"
                        fill="#331B0C"
                        fillRule="evenodd"
                        xlinkHref="#react-path-122"
                      ></use>
                      <g
                        id="Color/Hair/Brown"
                    ...
                    <mask id="react-mask-66" fill="white">
                      <use xlinkHref="#react-path-68"></use>
                    </mask>
                    <use
                      id="Short-Hair"
                      stroke="none"
